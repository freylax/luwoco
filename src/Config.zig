...
// size: 1  16
simulator_delaying_time_cs: u8 = 8,
// size: 1  17
x_max_segment_duration_ds: u8 = 40,
// size: 1  18
y_max_segment_duration_ds: u8 = 40,
// size: 1  19
after_move_time_ds: u8 = 2,
// size: 1 20
x_lim_check_delay_cs: u8 = 10,
// size: 1 21
y_lim_check_delay_cs: u8 = 10,
// size: 2 23
...
pub fn read(self: *Self) void {
    mem.copyForwards(u8, mem.asBytes(self), journal.read()[0..my_size]);
}
